 ...
 * @param simulator
 */
void VLayersProcessor::VLayersProcessor(VSimulatorPtr simulator) {
 ...
 * @return size_type
 */
size_type VLayersProcessor::getLayersNumber() {
    return null;
}
 ...
 * @return size_type
 */
size_type VLayersProcessor::getInactiveLayersNumber() {
    return null;
}
 ...
 * @return double
 */
double VLayersProcessor::getMedianDistance() {
    return 0.0;
}
